      ...
      if (isTemplate) { // if it is a template
        ...
        if (this.state.hasInitiated) {
          ...
          document.querySelectorAll('.block').forEach(i => {
            this.blocksKey++;
            blocks.push(<Block EmailBuilder={this} key={this.blocksKey} HTML={i} />)
          })
 ...
 ********************/
  ...
  printBlocks = () => {
    if (this.state.blocks.length === 0) {
      return (
        <div>
          <div style={{maxWidth: '250px'}} className="button background--highlight text--white">
            Import an old email.
          ...
          {(() => {if (this.state.templateBlocks.length > 0){ return (
              <button style={{maxWidth: '250px'}} className="button background--blue text--white" onClick={this.resetEmail}>
                Start a new email.
              </button>
          ) }})()}
    ...
    if (this.state.hasInitiated) {
      return (
        <div id="email-builder-app" className="unwrap">
          ...
          <div id="template-blocks__toggle" className="template-blocks__toggle--visible destroy" onClick={this.toggleTemplateBlocks}>
              Template Blocks
          </div>
          ...
          <ImageEditor EmailBuilder={this} ref={input => {this.imageEditor = input}} bank={this.imageBank} />
        ...
        return (
          <div>
            ...
            <div id="docs" className="text-block">
              <div className="text-block__wrapper">
                <h1>Docs</h1>
